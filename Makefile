...
LDFLAGS   = -nostartfiles -Wl,-Map=$(PROGRAM).map,--cref,--gc-sections --specs=nano.specs -u _printf_float
...
COMPILE.c   = $(CC)  $(MY_CFLAGS) $(CFLAGS)   $(CPPFLAGS) -c $(INCDIRS)
COMPILE.cxx = $(CXX) $(MY_CFLAGS) $(CXXFLAGS) $(CPPFLAGS) -c
LINK.c      = $(CC)  $(MY_CFLAGS) $(CFLAGS)   $(CPPFLAGS) $(LDFLAGS)
LINK.cxx    = $(CXX) $(MY_CFLAGS) $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)
 
.PHONY: all objs tags ctags help show
...
%.elf:$(OBJS)
	$(CC) $(OBJS) -mcpu=cortex-m3 -mthumb -lm -T$(LDSCRIPT) $(LDFLAGS) -o $@

clean:
	$(RM) $(OBJS) $(PROGRAM).hex $(PROGRAM).elf
